...
def main():
    output_dir = Path(r"D:\rustProject\autovideo-ai\outputs\phase10\animatediff_8")
    frames_dir = output_dir / "frames"
    frames_dir.mkdir(parents=True, exist_ok=True)
    output_meta = output_dir / "metadata.json"

    print("=== AutoVideo AI Phase 10 Gate 2: AnimateDiff 8-Frame Real Neural Inference ===")
    ...
    # 4GB VRAM hardware optimizations: sequential CPU offload
    ...
    print("=== Phase 10 Gate 2 AnimateDiff 8-Frame SUCCESS ===")
